export default class {
  constructor () {
    return [
      ...
      ['C_A_2', {
        'x': 7, 'y': 2, 'type': 'C', 'name': '炮', 'camp': 'A'
      }],
      ['S_A_1', {
        'x': 0, 'y': 3, 'type': 'S', 'name': '兵', 'camp': 'A'
      }],
      ['S_A_2', {
        'x': 2, 'y': 3, 'type': 'S', 'name': '兵', 'camp': 'A'
      }],
      ['S_A_3', {
        'x': 4, 'y': 3, 'type': 'S', 'name': '兵', 'camp': 'A'
      }],
      ['S_A_4', {
        'x': 6, 'y': 3, 'type': 'S', 'name': '兵', 'camp': 'A'
      }],
      ['S_A_5', {
        'x': 8, 'y': 3, 'type': 'A', 'name': '兵', 'camp': 'A'
      }],
      ['G_A_1', {
        'x': 4, 'y': 0, 'type': 'G', 'name': '帅', 'camp': 'A'
      }],
      ['R_B_1', {
        'x': 0, 'y': 9, 'type': 'R', 'name': '車', 'camp': 'B'
      }],
      ['R_B_2', {
      ...
      ['M_B_2', {
        'x': 5, 'y': 9, 'type': 'M', 'name': '士', 'camp': 'B'
      }],
      ['C_B_1', {
        'x': 1, 'y': 7, 'type': 'C', 'name': '炮', 'camp': 'B'
      }],
      ['C_B_2', {
